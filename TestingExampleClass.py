from check_box import check_box_parallel, check_box
import matplotlib.pyplot as plt
from plotter_support_functions import uni_plotter
from timeit import default_timer as timer

class Example:
    def __init__(self, extension, parallel=False, record_time=False, strategy="Default"):
        """
    ...
    def check_box(self, grid_u, dim_u, v_ival, eps, grid_v=None, v_dim=None, uniform_u=None, uniform_v=None):
        ...
        if self.parallel:
            area_boxes, border_boxes = check_box_parallel(grid_u, dim_u, v_ival, \
                               ...
                               grid_v=grid_v, uniform_u=uniform_u, uniform_v=uniform_v)
        else:
